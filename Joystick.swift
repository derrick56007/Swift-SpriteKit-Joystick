...
class Joystick : SKNode {
    ...
    func anchorPointInPoints() -> CGPoint { return CGPointMake(0, 0) }
    ...
    override func touchesBegan(touches: Set<NSObject>, withEvent event: UIEvent) {
        ...
        for touch in touches {
            ...
            if let touch = touch as? UITouch {
                ...
                let thumbNodeContainsTouch = CGRectContainsPoint(self.thumbNode.frame, touchPoint)
                
                if self.isTracking == false && thumbNodeContainsTouch { self.isTracking = true }
    ...
    override func touchesEnded(touches: Set<NSObject>, withEvent event: UIEvent) { self.resetVelocity() }
    
    override func touchesCancelled(touches: Set<NSObject>!, withEvent event: UIEvent!) { self.resetVelocity() }
